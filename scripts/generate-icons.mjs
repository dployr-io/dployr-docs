...
// wordmark-light: 400×80, transparent bg, white logo + text
...
const wordmarkLightEl = {
  ...
  props: {
    ...
    children: [
      {
        type: 'img',
        props: { src: logoSvgLight, width: 58, height: 58 },
      },
      {
        type: 'div',
        props: {
...
const svgStrLight = await satori(wordmarkLightEl, { width: 400, height: 80, fonts })
await sharp(Buffer.from(svgStrLight)).png().toFile(join(outDir, 'wordmark-light.png'))
console.log('Generated wordmark-light.png')
